  ...
  Q.InputSystem = Q.Evented.extend({
    ...
    keyboardControls: function(keys) {
     ...
     enableMouse: function() {
         ...
         Q.el.mousedown(function(e) {
             Q.inputs["mousedown"] = true;
             e.preventDefault();
         });

         Q.el.mouseup(function(e) {
             Q.inputs["mousedown"] = false;
             e.preventDefault();
         });

         Q.el.mousemove(function(e) {
             Q.input.mousePosition.x = e.offsetX;
             Q.input.mousePosition.y = e.offsetY;
         });
